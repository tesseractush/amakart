...
<nav class="navbar navbar-expand-lg navbar-dark btn-dark">
  ...
  <!-- Navbar brand -->
  <a class="navbar-brand" href="#">Amakart</a>
...
#2
if(isset($html->find('div[class="_4rR01T"]',1)->plaintext)){
  
echo  $html->find('div[class="_4rR01T"]',1)->plaintext;
}
echo "<span class='float-right'>";

if(isset($html->find('div[class="_30jeq3 _1_WHN1"]',1)->plaintext)){
...
#3
if(isset($html->find('div[class="_4rR01T"]',2)->plaintext)){
  
echo  $html->find('div[class="_4rR01T"]',2)->plaintext;
}
echo "<span class='float-right'>";

if(isset($html->find('div[class="_30jeq3 _1_WHN1"]',2)->plaintext)){
...
if(isset($html->find('div[class="_4rR01T"]',3)->plaintext)){
  
echo  $html->find('div[class="_4rR01T"]',3)->plaintext;
}
echo "<span class='float-right'>";

if(isset($html->find('div[class="_30jeq3 _1_WHN1"]',3)->plaintext)){
  
echo  $html->find('div[class="_30jeq3 _1_WHN1"]',3)->plaintext;
}
...
#2
 ...
 if(isset($html->find('span[class="a-size-medium a-color-base a-text-normal"]',1)->plaintext)){
  echo $html->find('span[class="a-size-medium a-color-base a-text-normal"]',1)->plaintext;
}
echo "<span class='float-right'>";

if(isset($html->find('span[class="a-price-whole"]',1)->plaintext)){
...
#3
 ...
 if(isset($html->find('span[class="a-size-medium a-color-base a-text-normal"]',2)->plaintext)){
  echo $html->find('span[class="a-size-medium a-color-base a-text-normal"]',2)->plaintext;
}
echo "<span class='float-right'>";

if(isset($html->find('span[class="a-price-whole"]',2)->plaintext)){
...
#4
 ...
 if(isset($html->find('span[class="a-size-medium a-color-base a-text-normal"]',3)->plaintext)){
  echo $html->find('span[class="a-size-medium a-color-base a-text-normal"]',3)->plaintext;
}
echo "<span class='float-right'>";

if(isset($html->find('span[class="a-price-whole"]',3)->plaintext)){
    echo $html->find('span[class="a-price-symbol"]',3)->plaintext;

  echo $html->find('span[class="a-price-whole"]',3)->plaintext;
}
echo "</span><br><br>";
...
?>
            ...
            <hr>
           <button type="button" class="btn btn-primary"><a href="https://www.amazon.in" id="visitsite">Visit amazon</a></button>
          </div>
          <!--Card content-->
